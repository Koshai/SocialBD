...
export function createLinkedInOAuthState(payload: Omit<OAuthStatePayload, "nonce">) {
...
export function verifyLinkedInOAuthState(state: string): OAuthStatePayload | null {
...
export function getLinkedInOAuthStateCookieOptions() {
  return {
    name: COOKIE_NAME,
...
export function getLinkedInOAuthStateCookieName() {
  return COOKIE_NAME;
}
